    ...
    <main className="form-container">
      ...
      <form className="login-form" onSubmit={handleSubmit}>
        ...
        <div className="input-box">
          ...
          <div className="input-field">
            <input type={isPasswordVisible ? 'text' : 'password'} name="password" id="password" className="form-control" placeholder="*******" value={formData.password} onChange={handleChange} required />
            <FontAwesomeIcon icon={isPasswordVisible ? faEye : faEyeSlash} className="password-icon" onClick={togglePasswordVisibility} style={{ cursor: 'pointer' }} />
          </div>
        </div>
